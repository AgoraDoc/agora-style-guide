...
| One-to-one Classroom                         | One-to-one Classroom                | A teacher gives an online lesson to only one student. |
...
| Live-stream Shopping                         | Live-stream Shopping                | Engaging online shopping.                    |
...
| Breakout Class                               | Breakout Class                      | Divide the students in a large online class into small groups, and students in one group can interact with each other. |
...
| <a href="https://console.agora.io/">Agora Console</a>            | Agora Console                       | A platform for creating and managing Agora projects. Previously Agora Dashboard. |
| Agora Electron SDK                           | Electron SDK                        | "Agora RTC Electron SDK" is also used, but "Agora Electron SDK" is the preferred term in our documentation. |
| Agora Lab, Inc.                              | Agora                               | Holding company for Agora. Not used in technical documentation. |
| Agora MediaPlayer Kit                        | Mediaplayer Kit                     | A media player plug-in developed for live streaming scenarios, and is compatible with the Agora Native SDK. |
| Agora RTC Native SDK                         | Native SDK                          | Enables easy and convenient one-to-one or one-to-many calls and supports voice-only and video features. |
| Agora On-premise Recording SDK               | On-premise Recording SDK            | Records and saves voice calls, video calls, and interactive streaming sessions to a server. |
...
| Agora RTC Web SDK                            | Web SDK                             | Uses APIs in the web browser to establish connections and control the communication and live streaming services. |
...
- **extract**: Use instead of *unarchive*, *uncompress*, or *unzip*.
...
- **last mile**: Always two separate words, can be used as noun or adjective.
- **later**: Use instead of *higher* when describing a version.
- **live stream** (intransitive verb or noun)
- **live streaming**: Use *live streaming* to refer to Agora products and scenarios.
...
- **packet loss rate**
- **page**: Use *this page* instead of *this article*.
...
- **sign up** (verb), **sign-up** (noun or adjective)
- **SOCKS5**
